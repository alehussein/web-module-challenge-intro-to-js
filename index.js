...
else {console.log("Task 1a", false);
  }
...
let firstThing = 'b' ;
let secondThing = 'b' ;
if (firstThing == secondThing) { firstThing = 'c' ; }
...
*/
const Numero = "1999";
console.log("Task 1c", Number(Numero));
...
console.log("Task 2", dogYears(41))
...
else if (computer > 0.67){computer ='scissors'}
